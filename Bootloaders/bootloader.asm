...
start:; start label from where our code starts
    ...
    hello_world: db 'Hello World!',13,0; 13=/n, 0=NULL
...
.repeat_next_char:
    ...
    cmp al, 0                    ; cmp al with null char (0)
...
.done_print:
    ...
    times (510 - ($ - $$)) db 0x00     ;set 512 bytes (magic number)  for boot sector which are necessary
